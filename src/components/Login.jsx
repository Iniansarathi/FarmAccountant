...
import { requestGoogleToken } from '../services/auth';
...
export default function Login() {
  ...
  return (
    <div className="min-h-svh w-full flex flex-col justify-between bg-slate-50 px-4 py-8">
      ...
      {/* Main card */}
      <div className="w-full max-w-sm mx-auto glass-card rounded-3xl p-8 border border-slate-200 shadow-xl text-center space-y-6">
        
        {/* Brand logo */}
        <div className="space-y-3">
          <div className="w-16 h-16 bg-[#0C9D61] text-white rounded-2xl flex items-center justify-center mx-auto shadow-md shadow-[#0c9d61]/25">
          ...
          <p className="text-xs text-slate-500 font-semibold max-w-[250px] mx-auto mt-2 leading-relaxed">
            {t('app_subtitle')}
          </p>
        </div>
        ...
        <div className="space-y-3 pt-2">
          ...
          <button
            ...
            className="w-full py-3 bg-[#0C9D61] hover:bg-emerald-700 text-white font-bold text-xs sm:text-sm rounded-xl transition-all cursor-pointer hover-scale hover-scale-active shadow-md shadow-emerald-100 flex items-center justify-center gap-2.5"
          >
          ...
          {/* Reset Permissions options */}
          <button
            onClick={() => handleGoogleLogin(true)}
            className="w-full py-2 bg-white hover:bg-slate-50 text-slate-505 text-slate-500 font-semibold text-[11px] rounded-xl border border-slate-200 transition-all cursor-pointer flex items-center justify-center gap-1.5 shadow-sm"
        ...
        <p className="text-[10px] text-slate-450 leading-relaxed text-slate-400 font-medium text-left">
